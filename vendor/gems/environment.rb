...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rest-client-1.0.3/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rest-client-1.0.3/lib")
  ...
  @bundled_specs = {}
  @bundled_specs["rest-client"] = eval(File.read("#{dir}/specifications/rest-client-1.0.3.gemspec"))
  @bundled_specs["rest-client"].loaded_from = "#{dir}/specifications/rest-client-1.0.3.gemspec"
